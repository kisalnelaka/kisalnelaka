...
def generate_banner(stats):
  ...
  <text x="36" y="30" font-family="system-ui,-apple-system,sans-serif" font-size="10.5" font-weight="500" fill="#6b7280" letter-spacing="0.5">open to interesting problems</text>
